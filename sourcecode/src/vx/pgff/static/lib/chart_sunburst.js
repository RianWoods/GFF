    ...
    this.svg = d3.select(idview).append('svg')
        ...
        .on('click',  function(d){
            if (selft.ispresskey == 0) {
                console.log("selft.ispresskey", selft.ispresskey);
                focusOn(d);
            }
...
//                if (error) throw error;
    ...
    self.drawchart = function(){
        ...
        self.newSlice.append('title')
            ...
            .text(d => d.data.name +": "+ self.ranking[d.data.id]+ '\n');
...
//            .style('fill', d => color((d.children ? d : d.parent).data.name))
            .style('fill', function(d){
                ...
                //console.log(graph.nodes[d.data.name]);
                //return 
