    ...
    this.main = function () {
        ...
        -->
                    ...
                    >
                        ...
                        <div class="progress">
                            <div id="`+self.idstatus+`" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
                            </div>
                        </div>
                    </div>
                </div>
